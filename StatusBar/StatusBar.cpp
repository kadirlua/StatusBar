// StatusBar.cpp : Defines the initialization routines for the DLL.
//
...
bool irPlg_ShowHelpForAction(char* lpszActionName, char* lpszPluginPath, HWND hParentWnd)
{
	...
	strHelpFile.Format("%s\\StatusBar_Help.htm",lpszPluginPath);
